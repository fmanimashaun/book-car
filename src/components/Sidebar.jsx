...
const SideNavBar = () => {
  ...
  return (
    <div className="flex justify-between">
      ...
      <div
        className={`lg:block lg:relative w-64 lg:flex-none bg-white z-40 h-full ${
          isSidebarOpen ? 'absolute flex' : 'hidden'
        }`}
      >
        <aside
          className="relative z-40 flex flex-col lg:p-auto items-center w-64 h-screen border-r-2"
          aria-label="Sidebar"
        >
