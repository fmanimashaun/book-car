...
const Reserve = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(151, 191, 15, 0.9), rgba(151, 191, 15, 0.9)), url(${carCollage})`,
      }}
    >
      ...
      <form
        ...
        className="pt-5 flex justify-around font-medium"
      >
        {error && <p>{error}</p>}
        <select
          className="bg-light-green p-4 rounded-full border-2 border-white focus:outline-none"
          id="carId"
          name="carId"
          value={carId}
        ...
        />
        <button
          className="bg-white p-4 rounded-full border border-white text-light-green"
          type="submit"
        >
          Book now
        </button>
